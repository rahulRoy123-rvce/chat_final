...
const TOU = () => {
  return (
    <>
      <h2 className="text-center text-xl font-bold mt-10 mb-3 md:text-4xl">
        Terms of Use
      </h2>

      <p className="mx-5 my-5 text-sm md:mx-14">
        ...
        RichFeyn web site located at{" "}
        <a
          href="https://www.richfeyn.com/"
        ...
        by RichFeyn, its subsidiaries and affiliates, including RichFeyn sites
        around the world (collectively, the "Site"). The Site is the property of
        RichFeyn Inc. ("RichFeyn") and its licensors. BY USING THE SITE, YOU
        AGREE TO THESE TERMS OF USE; IF YOU DO NOT AGREE, DO NOT USE THE SITE.
        <br />
        RichFeyn reserves the right, at its sole discretion, to change, modify,
        ...
        with these Terms of Use, RichFeyn grants you a personal, non-exclusive,
      ...
      <p className="mx-5 my-5 text-sm md:mx-14">
        ...
        or licensed by or to RichFeyn, and is protected by trade dress,
        ...
        enterprise, without RichFeyn's express prior written consent.
        <br />
        You may use information on RichFeyn products and services (such as data
        sheets, knowledge base articles, and similar materials) purposely made
        available by RichFeyn for downloading from the Site, provided that you
      ...
      <p className="mx-5 my-5 text-sm md:mx-14">
        <strong className="text-lg">Your Use of the Site</strong>
        <br />
        ...
        Site. RichFeyn reserves the right to bar any such activity.
        <br />
        ...
        Site or to any RichFeyn server, or to any of the services offered on or
        ...
        user of or visitor to the Site, or any other customer of RichFeyn,
        including any RichFeyn account not owned by you, to its source, or
        ...
        RichFeyn's systems or networks, or any systems or networks connected to
        the Site or to RichFeyn.
        <br />
        ...
        RichFeyn on or through the Site or any service offered on or through the
      ...
      <p className="mx-5 my-5 text-sm md:mx-14">
        ...
        <br />
        RichFeyn's obligations, if any, with regard to its products and services
        ...
        agreements.
        <br />
        RichFeyn may make changes to any products or services offered on the
        Site, or to the applicable prices for any such products or services, at
        any time, without notice. The materials on the Site with respect to
        products and services may be out of date, and RichFeyn makes no
        commitment to update the materials on the Site with respect to such
        products and services.
      </p>

      <p className="mx-5 my-5 text-sm md:mx-14">
        <strong className="text-lg">Accounts, Passwords and Security</strong>
        <br />
        Certain features or services offered on or through the Site may require
        you to open an account (including setting up an RichFeyn ID and
        ...
        confidential. You agree to notify RichFeyn immediately of any
        unauthorized use of your account or password, or any other breach of
        security. You may be held liable for losses incurred by RichFeyn or any
        other user of or visitor to the Site due to someone else using your
        RichFeyn ID, password or account as a result of your failing to keep
        your account information secure and confidential.
        <br />
        You may not use anyone else's RichFeyn ID, password or account at any
        time without the express permission and consent of the holder of that
        RichFeyn ID, password or account. RichFeyn cannot and will not be liable
      ...
      <p className="mx-5 my-5 text-sm md:mx-14">
        ...
        <br />
        RichFeyn's Privacy Policy applies to use of this Site, and its terms are
        made a part of these Terms of Use by this reference. To view RichFeyn's
        Privacy Policy, click here. Additionally, by using the Site, you
      ...
      <p className="mx-5 my-5 text-sm md:mx-14">
        <strong className="text-lg">
          Links to Other Sites and to the RichFeyn Site
        </strong>
        <br />
        ...
        convenience to our visitors. Such Linked Sites are not under RichFeyn's
        control, and RichFeyn is not responsible for and does not endorse the
      ...
      <p className="mx-5 my-5 text-sm md:mx-14">
        ...
        <br />
        RICHFEYN DOES NOT PROMISE THAT THE SITE OR ANY CONTENT, SERVICE OR
        ...
        SUBJECT TO CHANGE WITHOUT NOTICE. RICHFEYN CANNOT ENSURE THAT ANY FILES
        OR OTHER DATA YOU DOWNLOAD FROM THE SITE WILL BE FREE OF VIRUSES OR
        CONTAMINATION OR DESTRUCTIVE FEATURES. RICHFEYN DISCLAIMS ALL
        WARRANTIES, EXPRESS OR IMPLIED, INCLUDING ANY WARRANTIES OF ACCURACY,
        NON-INFRINGEMENT, MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE.
        RICHFEYN DISCLAIMS ANY AND ALL LIABILITY FOR THE ACTS, OMISSIONS AND
        CONDUCT OF ANY THIRD PARTIES IN CONNECTION WITH OR RELATED TO YOUR USE
        OF THE SITE AND/OR ANY RICHFEYN SERVICES. YOU ASSUME TOTAL
        RESPONSIBILITY FOR YOUR USE OF THE SITE AND ANY LINKED SITES. YOUR SOLE
        REMEDY AGAINST RICHFEYN FOR DISSATISFACTION WITH THE SITE OR ANY CONTENT
        IS TO STOP USING THE SITE OR ANY SUCH CONTENT. THIS LIMITATION OF RELIEF
        ...
        <br />
        RichFeyn reserves the right to do any of the following, at any time,
      ...
      <p className="mx-5 my-5 text-sm md:mx-14">
        ...
        <br />
        Except where prohibited by law, in no event will RichFeyn be liable to
        you for any indirect, consequential, exemplary, incidental or punitive
        damages, including lost profits, even if RichFeyn has been advised of
        the possibility of such damages.
        <br />
        If, notwithstanding the other provisions of these Terms of Use, RichFeyn
        is found to be liable to you for any damage or loss which arises out of
        or is in any way connected with your use of the Site or any Content,
        RichFeyn's liability shall in no event exceed the greater of (1) the
        total of any subscription or similar fees with respect to any service or
        feature of or on the Site paid in the six months prior to the date of
        the initial claim made against RichFeyn (but not including the purchase
        price for any RichFeyn hardware or software products or any RichFeynCare
        or similar support program), or (2) US$100.00. Some jurisdictions do not
      ...
      <p className="mx-5 my-5 text-sm md:mx-14">
        ...
        <br />
        You agree to indemnify and hold RichFeyn, its officers, directors,
        ...
        claims or expenses (including attorney's fees), made against RichFeyn by
        any third party due to or arising out of or in connection with your use
        of the Site.
      </p>

      <p className="mx-5 my-5 text-sm md:mx-14">
        <strong className="text-lg">Violation of These Terms of Use</strong>
        <br />
        RichFeyn may disclose any information we have about you (including your
        ...
        unintentionally) RichFeyn's rights or property, or the rights or
        property of visitors to or users of the Site, including RichFeyn's
        customers. RichFeyn reserves the right at all times to disclose any
        information that RichFeyn deems necessary to comply with any applicable
        law, regulation, legal process or governmental request. RichFeyn also
        may disclose your information when RichFeyn determines that applicable
        law requires or permits such disclosure, including exchanging
        information with other companies and organizations for fraud protection
        purposes.
        <br />
        You acknowledge and agree that RichFeyn may preserve any transmittal or
        communication by you with RichFeyn through the Site or any service
        offered on or through the Site, and may also disclose such data if
        required to do so by law or RichFeyn determines that such preservation
        or disclosure is reasonably necessary to (1) comply with legal process,
        (2) enforce these Terms of Use, (3) respond to claims that any such data
        violates the rights of others, or (4) protect the rights, property or
        personal safety of RichFeyn, its employees, users of or visitors to the
        Site, and the public.
        <br />
        You agree that RichFeyn may, in its sole discretion and without prior
        ...
        will cause irreparable harm to RichFeyn, for which monetary damages
        would be inadequate, and you consent to RichFeyn obtaining any
        injunctive or equitable relief that RichFeyn deems necessary or
        appropriate in such circumstances. These remedies are in addition to any
        other remedies RichFeyn may have at law or in equity.
      </p>
      <p className="mx-5 my-5 text-sm md:mx-14">
        You agree that RichFeyn may, in its sole discretion and without prior
        ...
        issues or problems.
        <br />
        If RichFeyn does take any legal action against you as a result of your
        violation of these Terms of Use, RichFeyn will be entitled to recover
        from you, and you agree to pay, all reasonable attorneys' fees and costs
        of such action, in addition to any other relief granted to RichFeyn. You
        agree that RichFeyn will not be liable to you or to any third party for
        termination of your access to the Site as a result of any violation of
        these Terms of Use.
      </p>

      <p className="mx-5 my-5 text-sm md:mx-14">
        <strong className="text-lg">Governing Law; Dispute Resolution</strong>
        <br />
        ...
        RichFeyn and you arising out of or in connection with your use of the
        Site, the parties shall attempt, promptly and in good faith, to resolve
        any such dispute. If we are unable to resolve any such dispute within a
      ...
      <p className="mx-5 my-5 text-sm md:mx-14">
        <strong className="text-lg">Void Where Prohibited</strong>
        <br />
        RichFeyn administers and operates the{" "}
        <a
          href="https://www.richfeyn.com/"
          class="font-medium text-blue-600 dark:text-blue-500 underline"
        >
        ...
        Site from its location in Cupertino, California USA; other RichFeyn
        sites may be administered and operated from various locations outside
        the United States. Although the Site is accessible worldwide, not all
        ...
        United States. RichFeyn reserves the right to limit, in its sole
        ...
        choose to access the Site from outside the United States, you do so on
        your own initiative and you are solely responsible for complying with
        applicable local laws.
      </p>

      <p className="mx-5 my-5 text-sm md:mx-14">
        <strong className="text-lg">Miscellaneous</strong>
        <br />
        ...
        agreement between you and RichFeyn with regard to your use of the Site,
        and any and all other written or oral agreements or understandings
        previously existing between you and RichFeyn with respect to such use
        are hereby superseded and cancelled. Other than as provided in a
        purchase agreement you enter into with RichFeyn, RichFeyn will not
        accept any counter-offers to these Terms of Use, and all such offers are
        hereby categorically rejected. RichFeyn's failure to insist on or
        enforce strict performance of these Terms of Use shall not be construed
        as a waiver by RichFeyn of any provision or any right it has to enforce
        these Terms of Use, nor shall any course of conduct between RichFeyn and
        you or any other party be deemed to modify any provision of these Terms
        of Use. These Terms of Use shall not be interpreted or construed to
        confer any rights or remedies on any third parties.
        <br />
        RichFeyn provides access to RichFeyn international data and, therefore,
        may contain references or cross references to RichFeyn products,
        programs and services that are not announced in your country. Such
        reference does not imply that RichFeyn in your country intends to
        announce such products, programs or services.
      </p>

      <p className="mx-5 my-5 text-sm md:mx-14">
        <strong className="text-lg">Feedback and Information</strong>
        <br />
        Any feedback you provide at this site shall be deemed to be
        non-confidential. RichFeyn shall be free to use such information on an
        unrestricted basis.
      </p>
      <p className="mx-5 my-5 text-xl font-light italic md:mx-12">
        The information contained in this web site is subject to change without
        notice.
        <br />
        Updated by The RichFeyn Legal Team on Aug. 12, 2023
      </p>
    </>
  );
};
